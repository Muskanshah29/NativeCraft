...
// Example Output Component for Bottom Tab Navigation
const ExampleOutput = () => {
  return (
    <NavigationContainer>
...
const BottomTabNav = ({ language = 'javascript', theme = atomOneDark }) => {
  const codeString = `
import React from 'react';
import { createBottomTabNavigator } from '@react-navigation/bottom-tabs';
import { NavigationContainer } from '@react-navigation/native';
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.description}>
        The Bottom Tab Navigator provides an easy way to navigate between different screens in an app using a tab bar at the bottom of the screen.
      </Text>

      <Text style={styles.subtitle}>What is Bottom Tab Navigator?</Text>
      <Text style={styles.description}>
        Bottom Tab Navigator is a type of navigation in React Native that allows you to switch between different screens using a tab bar at the bottom of the app.
      </Text>
